    ...
    return (
        <Dropzone multiple={false} onDrop={
            async (acceptedFiles) => {
                ...
                const progressInterval = simulatedProgressBar();
                ...
                const [fileResponse] = res; //This will give us the key
                        ...
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 " >
                            <div className="flex flex-col items-center justify-center pt-5 pb-6 " >
                                ...
                                <p className="mb-2 text-sm text-zinc-700  " >
                                    <span className="font-semibold" >Drag &apos;n&apos; drop some files here, or click to upload</span>
                                </p>
                            ...
                            {acceptedFiles && acceptedFiles[0] ? (
                                <div className="max-w-xs bg-white flex items-center rounded-md overflow-hidden outilne outline-[1px] outline-zinc-200 divide-x divide-zinc-200 " >
